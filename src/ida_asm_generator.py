...
class IDAAsmGenerator(object):
    ...
    def __init__(self):
        self.ida_executable = '/cygdrive/c/Program\ Files/IDA\ Free/idag.exe'
        self.exe_path = '../exe'
        self.asm_path = '../asm'
    ...
    def generate_asm(self, file_name):
        ...
        commands.getoutput(generate_command)
    ...
    def move_asm(self, file_name):
        ...
        shutil.move('.' + os.sep + asm_file_name, self.asm_path + os.sep + asm_file_name)
